...
int __cdecl
HandleConnection::test_Connection(std::wstring addr, std::wstring prt=L"80", std::wstring params = L"")
{
	DWORD Error;
	DWORD OpenType = INTERNET_OPEN_TYPE_DIRECT;//INTERNET_OPEN_TYPE_PRECONFIG; // Use pre-configured options as default
	...
	SessionHandle = InternetOpen(L"WinInet HTTP Async Sample",  // User Agent
		...
		NULL,//Configuration.ProxyName,       // Proxy name
...
VOID
HandleConnection::ProcessRequest(
...
DWORD
HandleConnection::SendRequestWithBody(
	__in PREQUEST_CONTEXT ReqContext
)
/*++
...
DWORD
HandleConnection::GetDataToPost(
	__inout PREQUEST_CONTEXT ReqContext
)
/*++
...
DWORD
HandleConnection::PostDataToServer(
	__inout PREQUEST_CONTEXT ReqContext,
	__out PBOOL Eof
)
/*++
...
DWORD
HandleConnection::CompleteRequest(
	__inout PREQUEST_CONTEXT ReqContext
)
/*++
...
DWORD
HandleConnection::RecvResponseData(
	__inout PREQUEST_CONTEXT ReqContext
)
/*++
...
DWORD
HandleConnection::WriteResponseData(
	__in PREQUEST_CONTEXT ReqContext,
	__out PBOOL Eof
)
/*++
...
VOID
HandleConnection::CloseRequestHandle(
	__inout PREQUEST_CONTEXT ReqContext
)
/*++
...
BOOL
HandleConnection::AcquireRequestHandle(
	__inout PREQUEST_CONTEXT ReqContext
)
/*++
...
VOID
HandleConnection::ReleaseRequestHandle(
	__inout PREQUEST_CONTEXT ReqContext
)
/*++
...
DWORD
HandleConnection::AllocateAndInitializeRequestContext(
...
DWORD
HandleConnection::CreateWininetHandles(
	__inout PREQUEST_CONTEXT ReqContext,
	__in HINTERNET SessionHandle,
...
VOID
HandleConnection::WaitForRequestCompletion(
	__in PREQUEST_CONTEXT ReqContext,
	__in DWORD Timeout
)
/*++
...
VOID
HandleConnection::CleanUpRequestContext(
...
VOID
HandleConnection::CleanUpSessionHandle(
	__in HINTERNET SessionHandle
)
/*++
...
DWORD
HandleConnection::ParseArguments(
	__in int argc,
